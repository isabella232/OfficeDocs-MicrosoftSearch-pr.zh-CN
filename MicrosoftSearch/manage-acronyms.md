...
在 [Microsoft 365 管理中心](https://admin.microsoft.com)，转到 " [**首字母缩写词**](https://admin.microsoft.com/Adminportal/Home#/MicrosoftSearch/acronyms)"，然后选择 " **添加首字母缩略词**"。
...
| 首字母缩略词 (强制)  | 扩展 (强制)  | 说明  | Source | 状态 (强制)  |
| --------- | --------- | ---------- | --------- |--------- |
| *美元* | *拼写出缩写* |  | *URL* | *已发布或草稿* |
