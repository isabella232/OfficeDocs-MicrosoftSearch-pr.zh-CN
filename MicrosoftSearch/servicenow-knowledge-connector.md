---
title: ServiceNow 知识库Graph连接器Microsoft 搜索
ms.author: kam1
...
# <a name="servicenow-knowledge-graph-connector"></a>ServiceNow 知识库Graph连接器
...
ServiceNow 知识库Graph连接器在其最新版本中具有以下限制：

- *只有具有此数据源功能* 访问权限的用户才能在"管理搜索权限"步骤中处理 [用户条件](https://hi.service-now.com/kb_view.do?sysparm_article=KB0550924) 权限。 任何任何类型的访问权限将不会在搜索结果中应用。
